<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="退住编号" prop="tuizhubianhao">
					<el-input v-model="ruleForm.tuizhubianhao" placeholder="退住编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuizhubianhao" label="退住编号" prop="tuizhubianhao">
					<el-input v-model="ruleForm.tuizhubianhao" placeholder="退住编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房间类型" prop="fangjianleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="退住时间" prop="tuizhushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuizhushijian" label="退住时间" prop="tuizhushijian">
					<el-input v-model="ruleForm.tuizhushijian" placeholder="退住时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="护工账号" prop="hugongzhanghao">
					<el-input v-model="ruleForm.hugongzhanghao" placeholder="护工账号" clearable  :readonly="ro.hugongzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="护工账号" prop="hugongzhanghao">
					<el-input v-model="ruleForm.hugongzhanghao" placeholder="护工账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="护工姓名" prop="hugongxingming">
					<el-input v-model="ruleForm.hugongxingming" placeholder="护工姓名" clearable  :readonly="ro.hugongxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="护工姓名" prop="hugongxingming">
					<el-input v-model="ruleForm.hugongxingming" placeholder="护工姓名" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="退住备注" prop="tuizhubeizhu">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.tuizhubeizhu" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.tuizhubeizhu" label="退住备注" prop="tuizhubeizhu">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.tuizhubeizhu"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='tuizhubianhao'){
							this.ruleForm.tuizhubianhao = obj[o];
							this.ro.tuizhubianhao = true;
							continue;
						}
						...
						if(o=='tuizhubeizhu'){
							this.ruleForm.tuizhubeizhu = obj[o];
							this.ro.tuizhubeizhu = true;
							continue;
						}
						if(o=='hugongzhanghao'){
							this.ruleForm.hugongzhanghao = obj[o];
							this.ro.hugongzhanghao = true;
							continue;
						}
						if(o=='hugongxingming'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tuizhubeizhu = this.ruleForm.tuizhubeizhu.replace(reg,'../../../springbootto14d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
