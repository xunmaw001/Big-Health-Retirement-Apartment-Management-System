  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'  v-if="flag=='yonghu'" label="生日" prop="shengri">
            <el-date-picker
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='hugong'"  label="护工账号" prop="hugongzhanghao">
          <el-input v-model="ruleForm.hugongzhanghao" readonly              placeholder="护工账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='hugong'"  label="护工姓名" prop="hugongxingming">
          <el-input v-model="ruleForm.hugongxingming"               placeholder="护工姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='hugong'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='hugong'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='hugong'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.hugongzhanghao)&& 'hugong'==this.flag){
      ...
      if( 'hugong' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
        this.$message.error(`联系方式应输入手机格式`);
        return
      }
        if(this.ruleForm.touxiang!=null) {
