	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="收费说明" prop="shoufeishuoming">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shoufeishuoming" label="收费说明" prop="shoufeishuoming">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shoufeishuoming"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shoufeishuoming = this.ruleForm.shoufeishuoming.replace(reg,'../../../springbootto14d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
