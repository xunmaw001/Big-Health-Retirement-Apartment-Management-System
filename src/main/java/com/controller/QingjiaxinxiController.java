...
public class QingjiaxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,QingjiaxinxiEntity qingjiaxinxi,
		...
		if(tableName.equals("hugong")) {
			qingjiaxinxi.setHugongzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			qingjiaxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
