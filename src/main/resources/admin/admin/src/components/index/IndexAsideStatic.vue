<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#857EF0"}' class="el-menu-vertical-demo" default-active="0">
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #fff;
						background: rgba(133, 125, 216, 0.5);
						line-height: 50px;
						height: 50px;
					}
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item.is-active {
						padding: 0 40px;
						color: #fff;
						background: rgba(133, 125, 216, 0.8);
						line-height: 50px;
						height: 50px;
					}
		// 竖向
