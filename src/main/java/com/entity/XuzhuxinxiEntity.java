 ...
 */
@TableName("xuzhuxinxi")
public class XuzhuxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XuzhuxinxiEntity() {
		
	}
	
	public XuzhuxinxiEntity(T t) {
		try {
	 ...
	 * 设置：续住编号
	 */
	public void setXuzhubianhao(String xuzhubianhao) {
		this.xuzhubianhao = xuzhubianhao;
	}
	/**
	 * 获取：续住编号
	 */
	public String getXuzhubianhao() {
		return xuzhubianhao;
	}
	/**
	 * 设置：房间名称
