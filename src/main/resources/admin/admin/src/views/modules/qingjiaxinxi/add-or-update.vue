	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="请假原因" prop="qingjiayuanyin">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qingjiayuanyin" label="请假原因" prop="qingjiayuanyin">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qingjiayuanyin"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.qingjiashijian = this.getCurDate()
	},
	methods: {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.qingjiayuanyin = this.ruleForm.qingjiayuanyin.replace(reg,'../../../springbootto14d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
